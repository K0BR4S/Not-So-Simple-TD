...
public class Tileset {
    ...
    public static final TETile PAPER = new TETile('█', Color.white, Color.black, "paper", 14);


    public static TETile mWALL = new TETile('#', new Color(216, 128, 128), Color.darkGray,
            "wall", 1);
    public static TETile mFLOOR = new TETile('·', new Color(128, 192, 128, 128), Color.black, "floor", 2);
